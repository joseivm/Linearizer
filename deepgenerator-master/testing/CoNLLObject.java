...
/**
 * CoNLL Object is a class that is used to create testing and training files as well as to train and test classifiers for
...
public class CoNLLObject {
	...
	public CoNLLObject(String filePath){
	 ...
	 */
	public CoNLLObject(String filePath, String testPath){
		this.trainingFile = filePath;
	...
	public static void main(String [] args){
		...
		CoNLLObject transducer = new CoNLLObject("TrainingSet","TestingSet");
		...
		while(sentenceIt.hasNext()){
			...
			while(!queue.isEmpty()){
				...
				if(!sentence.getDeprel(nextNode).equals("ROOT")){
					...
					linModel.addLine3(nextNode, sentence, train);
	...
	public void sideTraining(){
	    ...
	    try
        {
               FileOutputStream fos = new FileOutputStream("sideRelMap.ser");
               ObjectOutputStream oos = new ObjectOutputStream(fos);
               oos.writeObject(sideRels);
               oos.close();
               fos.close();
               System.out.printf("Serialized HashMap data is saved in sideRelMap.ser");
